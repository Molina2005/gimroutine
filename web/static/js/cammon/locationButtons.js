...
// Recibe como parametro, clase del boton y identificador del cliente en este caso id
export async function LocationButtons(btnClass, clientData){
    ...
    buttons.forEach(btn =>{
        // Se crea evento que al dar click obtiene el id de ese cliente y luego lo pasa al parametro clientData
